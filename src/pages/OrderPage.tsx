	...
	return (
		<div className='h-full grid justify-around pb-36 sm:gap-24 px-2 md:gap-2 pt-16 md:grid-cols-2 items-center bg-neutral-50'>
			<div className='order-page-purchase'>
				...
				<p>Good man peen</p>
				<Link to='/purchasePage/Mint Condition Peen' className='link-purchase'>
					Purchase
				</Link>
			</div>
			...
			<div className='order-page-purchase'>
				...
				<p>Doesn't do much</p>
				<Link to='/purchasePage/Normal Peen' className='link-purchase'>
					Purchase
				</Link>
			</div>
			...
			<div className='order-page-purchase'>
				...
				<Link to='/purchasePage/Chill Peen' className='link-purchase'>
					Purchase
				</Link>
			</div>
			...
			<div className='order-page-purchase'>
				...
				<Link to='/purchasePage/Professor-P' className='link-purchase'>
					Purchase
				</Link>
			</div>
		</div>
