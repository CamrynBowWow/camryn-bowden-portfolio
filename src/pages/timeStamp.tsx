	...
	return (
		<div className='h-screen flex flex-col gap-2 items-center justify-center bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400'>
			...
			<div className='timestamp-container'>
				<p className='day-p-styling'>
					<span className='span-styling'>{days}</span>Days
				</p>
				<p className='day-p-styling'>
					<span className='span-styling'>{checkTime(hours)}</span>Hours
				</p>
				<p className='day-p-styling'>
					<span className='span-styling'>{checkTime(minutes)}</span>Minutes
				</p>
				<p className='day-p-styling'>
					<span className='span-styling'>{checkTime(seconds)}</span>Seconds
				</p>
			</div>
		</div>
	);
