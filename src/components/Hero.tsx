...
const Hero = () => {
  return (
    <div className='bg-neutral-50 h-screen flex flex-col justify-center items-center'>
        ...
        <Link to="/orderPage" className='py-6 px-10 bg-yellow-500 rounded-full text-3xl hover:bg-yellow-300 transition duration-300 ease-in-out flex items-center animate-bounce'>Order Now
